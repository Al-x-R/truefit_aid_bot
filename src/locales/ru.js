export default {
  ...
  pulse_calc_article_link: '*Хотите узнать больше о тренировках по пульсовым зонам?* Читайте наш пост: [Тренировки по пульсовым зонам](https://t.me/c/2595026988/20',
  ...
  tdee_report_article_link: '*Хотите глубже разобраться в питании и макросах?* Читайте наш пост: [Макронутриенты: Гид](https://t.me/c/2595026988/21)'
};
